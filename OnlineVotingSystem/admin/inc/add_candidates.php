...
if (isset($_GET['added'])) {
    ?>
    <div id="deleteMessage" class="alert alert-danger my-3" role="alert">
        Candidate has been added successfully!
        <button onclick="removeMessage()" class="btn btn-outline-dark btn-sm float-right">
    ...
    <?php
} else if (isset($_GET['candidate_id'])) {
    $d_id = $_GET['candidate_id'];
                ...
                if ($isAnyCandidateAdded > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($fetchingData)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#" class="btn btn-sm btn-danger" onclick="DeleteData(<?php echo $candidate_id; ?>)">
                                    Delete </a>
                            </td>
                        </tr>
                        <?php
...
<script>
    const DeleteData = (e_id) => {
        ...
        if (c == true) {
            location.assign("index.php?addCandidatePage=1&candidate_id=" + e_id);
        }
    }
</script>
